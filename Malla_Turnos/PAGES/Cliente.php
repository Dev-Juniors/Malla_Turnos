					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input type="text" class="form-control validate[required]" id="txtNombre"
									placeholder="Escriba el nombre del cliente" name="txtNombre"
									required />
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" class="form-control validate[required]" id="txtNit"
									placeholder="Escriba el NIT correspondiente" name="txtNit"
									required />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="selLinServ">Línea de Servicios <span
									class="required">*</span></label> <select class="form-control validate[required]"
									id="selLinServ" name="selLinServ" required>
